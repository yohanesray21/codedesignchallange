...
const TwitterEmbed = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center flex-col gap-6 dark:bg-black">
      <Switcher />
      <div className="max-w-xl mx-2 border shadow-2xl border-blue-200 border-opacity-70 bg-white dark:bg-[#243447] p-6 rounded-md">
